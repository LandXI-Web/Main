 ...
 */
/* 아직 값이 없는 필드 — 화면은 이것을 **지어내지 않는다**.
 *   cycle   법정 조사 주기. 발주처 확인 전이라 null 이다. 화면은 '주기 미정'으로 적고,
 *           대신 배포 연혁(DEPLOYS.year)을 보여 준다. infra.js 는 null 이면 연 1회로 잡는데,
 *           그 가정이 자원 산정에 그대로 들어가므로 값이 정해지면 먼저 여기를 채운다.
 *   org     소관 부서. 카드에 없어 묶은 모델(services.js ministry)에서 올려 쓰고 있다.
 *   projectId  모델 작업실과의 연결. 대응하는 학습 프로젝트가 없으면 null 이다. */
export const CARDS = [
  { id: 'card-farm', name: '영농관리 행정서비스', scope: 'local', duty: '농지 이용 실태조사 · 농업경영체 등록정보 확인',
    ...
    status: '운영', version: 'v2.1', projectId: 'pj-greenhouse', portable: true, cycle: null,
  ...
  { id: 'card-living', name: '생활환경 위험요소 탐지 서비스', scope: 'local', duty: '생활폐기물 · 불법 소각 · 방치폐기물 단속',
    ...
    status: '운영', version: 'v1.3', projectId: null, portable: true, cycle: null,
    projectGap: '판독 모델은 돌지만 학습 프로젝트가 models.js 에 없다 — 프로젝트 화면에서 역추적되지 않는다',
  ...
  { id: 'card-road', name: '도로 안전관리 서비스', scope: 'local', duty: '도로 포장 파손 정기 점검 · 보수 계획',
    ...
    status: '운영', version: 'v2.1', projectId: 'pj-road', portable: true, cycle: null,
  ...
  { id: 'card-crowd', name: '인파관리 서비스', scope: 'local', duty: '다중운집 행사 안전관리',
    ...
    services: [], ext: 'crowd',
    status: '준비 중', version: null, projectId: null, portable: true, cycle: null,
  ...
  { id: 'card-change', name: '국토 변화 탐지 서비스', scope: 'local', duty: '지적 재조사 · 무허가 건축물 확인',
    ...
    status: '검토', version: 'v1.0', projectId: 'pj-change', portable: true, cycle: null,
  ...
  { id: 'card-marine', name: '해양쓰레기 실태조사 서비스', scope: 'local', duty: '해안 쓰레기 실태조사 · 수거 계획',
    ...
    status: '운영', version: 'v1.2', projectId: null, portable: true, cycle: null,
    projectGap: '판독 모델은 돌지만 학습 프로젝트가 models.js 에 없다 — 프로젝트 화면에서 역추적되지 않는다',
  ...
  { id: 'card-forest', name: '산림·탄소 관리 서비스', scope: 'local', duty: '산림 훼손 점검 · 탄소 흡수량 산정',
    ...
    status: '준비 중', version: null, projectId: null, portable: false, cycle: null,
  ...
  { id: 'card-global-farm', name: '농지 이용 실태 분석 (해외)', scope: 'global', duty: 'Agricultural land use survey',
    ...
    status: '준비 중', version: null, projectId: 'pj-greenhouse', portable: true, cycle: null,
